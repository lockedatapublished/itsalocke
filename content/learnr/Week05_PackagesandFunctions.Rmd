...
Okay okay, we're biased over at Locke HQ with an average height of five feet and not many inches, but when it comes to R, it is true what they say, good things do come in small packages. And later on you'll notice how punny I've been there. 

Find yourself constantly repeating a set of operations? Bundle them up into a neat little function!

Find yourself using loads of self made functions over and over? Put them all together into a neat little package! We've got a bit ahead of ourselves here - as sure as I am that one day you'll be fluent and writing packages left, right and centre, we should take a look at some of the really good ones that have been built for us and are very widely used. 
...
## Installing packages
Once you've identified a package that contains functions or data you're interested in using^[Using CRAN or sites like rdrr.io], we need to get the package onto our machine.
