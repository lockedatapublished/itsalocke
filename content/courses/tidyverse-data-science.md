...
[style]
  center = false
+++
# Data Science the tidyverse way

{{<btn href="mailto://training@itsalocke.com" msg="Book now">}}

Update your data science skills in R by learning how we use packages from the tidyverse to make our lives significantly easier and quicker.

- Overview of the tidyverse data science packages
- Data manipulation
- Modern sampling strategies
- Building models
- Model evaluation
- Model deployment
